...
export const SOURCES: Record<JobSource, SourceMeta> = {
  ...
  Greenhouse: { id: 'Greenhouse', label: 'Greenhouse', flag: '🌱', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
  Lever: { id: 'Lever', label: 'Lever', flag: '🔷', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
  Ashby: { id: 'Ashby', label: 'Ashby', flag: '🟣', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
  Workable: { id: 'Workable', label: 'Workable', flag: '🔧', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
  Workday: { id: 'Workday', label: 'Workday', flag: '🏢', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  SmartRecruiters: { id: 'SmartRecruiters', label: 'SmartRecruiters', flag: '🧠', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
  Teamtailor: { id: 'Teamtailor', label: 'Teamtailor', flag: '👥', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  Personio: { id: 'Personio', label: 'Personio', flag: '🏢', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  BambooHR: { id: 'BambooHR', label: 'BambooHR', flag: '🎋', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  Rippling: { id: 'Rippling', label: 'Rippling', flag: '🔁', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  JazzHR: { id: 'JazzHR', label: 'JazzHR', flag: '🎷', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  Recruitee: { id: 'Recruitee', label: 'Recruitee', flag: '📢', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  iCIMS: { id: 'iCIMS', label: 'iCIMS', flag: '🏛️', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  Comeet: { id: 'Comeet', label: 'Comeet', flag: '☄️', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
  Jobvite: { id: 'Jobvite', label: 'Jobvite', flag: '🎬', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  Pinpoint: { id: 'Pinpoint', label: 'Pinpoint', flag: '📍', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40', locked: true },
  Join: { id: 'Join', label: 'Join', flag: '🤝', country: 'Global', region: 'global', apifyActorId: 'ats-direct', pricePer1K: '$0.40' },
